...
exports.getPrice = async (tokenName) =>{
    ...
    let tokenAddress[LINK] = '0x514910771af9ca656af840dff83e8264ecf986ca';
    ...
    const WETHPrice = await oracleContract.methods.current(tokenAddress[WETH], 1000000000000000000, tokenAddress[WETH]).call() / 1e6;
    const priceFeed =
        await oracleContract.methods.current(tokenAddress[tokenName], 1000000000000000000, tokenAddress[WETH]).call() / 1e18 * WETHPrice;
    return priceFeed;
}