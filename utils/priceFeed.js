...
exports.getPrice = async (tokenName) =>{
    ...
    const WETHPrice = await oracleContract.methods.current(tokenAddress['WETH'], web3.utils.toBN(String(1000000000000000000)), tokenAddress['USDC']).call() / 1e6;
    ...
    if(tokenName === 'WETH'){
        ...
        priceFeed =
        (await oracleContract.methods.current(tokenAddress[tokenName], web3.utils.toBN(String(1000000000000000000)), tokenAddress['WETH']).call() / 1e18) * WETHPrice;
    }
    return priceFeed;
}
